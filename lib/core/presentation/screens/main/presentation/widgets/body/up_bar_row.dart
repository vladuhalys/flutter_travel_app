    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        children: [
          ClipRRect(
            ...
            child: Image.asset(
              ...
              width: (GetPlatform.isAndroid || GetPlatform.isIOS) ? 50 : 200,
            ),
          ),
      ...
      Padding(
        ...
        child: InkWell(
          ...
          onTap: () {},
          child: Container(
            height: (GetPlatform.isAndroid || GetPlatform.isIOS) ? 50 : 75,
            width: (GetPlatform.isAndroid || GetPlatform.isIOS) ? 50 : 75,
            ...
            child: Center(
              child: badges.Badge(
                ...
                badgeStyle:
                    const badges.BadgeStyle(badgeColor: Color(0xFFFF7029)),
                child: SvgPicture.asset(
                  'assets/icons/notif.svg',
                  fit: BoxFit.cover,
                  width: (GetPlatform.isAndroid || GetPlatform.isIOS) ? 23 : 35,
                ),
              ),
            ),
          ),
